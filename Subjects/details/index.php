    ...
    <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form method="POST" action="php/ins.php">
                                ...
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        ...
                                        <?php
                                            while($row=mysqli_fetch_assoc($res))
                                            {
                                                    echo "<option value='".$row['facultyID']."'>".$row['facultyID']."=>".$row['userID']."</option>";
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="subject_code">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
