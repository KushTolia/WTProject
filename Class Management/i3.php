                        ...
                        while ($row = mysqli_fetch_assoc($sel)) {
                            ...
                            while ($row3 = mysqli_fetch_assoc($sel3)) {
                                ...
                                while ($row2 = mysqli_fetch_assoc($sel2)) {
                                    ...
                                    echo "<div class='class-info'>" . $row2["classID"] . " " . $row2["subjectCode"] . " " . $nm . "</div>";
                                }
                                echo "</td>";
                            }
                        }
...
<button type="button"  onclick="window.location.href = 'PHP/temp.php';"  class="m-3 btn btn-success btn-lg float-right">Book Lecture Slot</button>
