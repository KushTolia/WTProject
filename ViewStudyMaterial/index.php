<?php
    ...
    // {
    //         echo "<option>".$row['facultyID']."=>".$row['userID']."</option>";
        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    ...
                    ?>
                <div class="card-body">
                    <form method="POST" action="i2.php" enctype="multipart/form-data">
                      ...
                      <!-- select  <div class="form-row m-b-55">
                        ...
                        <div style="margin-top: 10%;">
                            ...
                            <button class="btn btn--radius-2 btn--red" onclick="location.href='../HomePage/sidebar-01/index.php'" type="button">Home</button>
                        </div>
                        <!-- <div class="mt-5">
